...
use moon_lol::{
    Action, PluginBarrack, PluginCore, PluginMap, PluginMinion, PluginResource,
    PluginSkillTestRender, PluginTurret, PluginUI, Riven, SkillTestRenderConfig,
    SkillTestScript, SkillTestScriptStep, SkillTestVideoFormat, SkillTestVideoOutput,
    attach_skill_test_actor,
};

#[test]
fn riven_q_combo_writes_video() {
    run_riven_case(
        "riven_q_combo_writes_video",
        180,
        vec![
