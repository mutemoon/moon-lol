...
pub struct PlayerInventoryViewController {
    ...
    pub unk_0x45fb73d6: Option<Unk0xf03c301d>,
    pub unk_0x5d9c5949: Option<Unk0x61516a3e>,
}
...
pub struct SkinCharacterDataProperties {
    ...
    pub unk_0x7d564f9a: Option<BTreeMap<String, Unk0x7d564f9a>>,
...
pub struct Unk0x61516a3e {
    ...
    pub stack_text: u32,
    pub toggle_fx: u32,
    pub unk_0x41fcbc3c: u32,
    pub unk_0x4fe2d9c8: u32,
    pub unk_0xbcfd24f4: u32,
    pub unk_0xfd3c6ba4: u32,
}
...
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct Unk0x7ac70a36 {
    pub default_texture_name: String,
    pub unk_0x2af14c7: String,
    pub unk_0x3d0587a: String,
    pub unk_0x71089646: String,
    pub unk_0x8df082e: String,
    pub unk_0x8fb9b7b0: String,
    pub unk_0x934eeacd: String,
    pub unk_0xa521a0c5: String,
    pub unk_0xb96a54f: String,
    pub unk_0xee6f7154: String,
    pub unk_0xf02aa447: String,
}

#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct Unk0x7d564f9a {}
...
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct Unk0xf03c301d {
    pub group: u32,
    pub hover_region: u32,
    pub icon: u32,
    pub texture_data: Unk0x7ac70a36,
}
