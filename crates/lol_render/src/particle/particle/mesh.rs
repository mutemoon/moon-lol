...
impl MaterialPath for ParticleMaterialMesh {
    const FRAG_SHADER: league_utils::LeagueShader = league_utils::LeagueShader::MeshPs;
    const VERT_SHADER: league_utils::LeagueShader = league_utils::LeagueShader::MeshVs;
}
