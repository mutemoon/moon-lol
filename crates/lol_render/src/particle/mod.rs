...
use crate::particle::emitters::update::update_emitters;
use crate::particle::particle::dynamic::PluginDynamicMaterial;
...
use crate::shader::{DebugShaderHandles, ShaderMap, startup_load_shaders};
...
impl Plugin for PluginParticle {
    fn build(&self, app: &mut App) {
        ...
        app.register_type::<crate::shader::ShaderMapEntry>();
        app.register_type::<crate::shader::SharedRenderData>();
        app.register_type::<crate::shader::SharedSamplerDef>();
        app.register_type::<crate::shader::SharedTextureDef>();
