...
fn on_rell_skill_cast(
    ...
    match skill.slot {
        SkillSlot::Q => cast_rell_q(&mut commands, entity, skill.key_spell_object.clone()),
        SkillSlot::W => cast_rell_w(&mut commands, entity, skill.key_spell_object.clone()),
        SkillSlot::E => cast_rell_e(&mut commands, entity, skill.key_spell_object.clone()),
        SkillSlot::R => cast_rell_r(&mut commands, entity, skill.key_spell_object.clone()),
        _ => {}
    }
}
