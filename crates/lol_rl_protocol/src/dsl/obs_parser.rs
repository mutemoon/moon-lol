use crate::dsl::common::{ident, number_f32, number_usize, symbol, ws, PResult};
        ...
        alt((
            ...
            delimited(
                ...
                (
                    ...
                    opt(preceded((symbol(","), symbol("pool"), symbol("=")), parse_pool_type)),
                ),
                symbol(")"),
            )
