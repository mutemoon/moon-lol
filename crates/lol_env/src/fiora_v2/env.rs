...
use super::action::{FIORA_V2_ACTION_SCHEMA, FioraV2Action, FioraV2DiscreteAction};
use super::obs::{FIORA_V2_OBS_SCHEMA, FioraV2Obs, get_v2_obs_from_world};
use super::step::{dispatch_action_world, setup_v2_fiora_riven_world, step_v2_world};
use crate::base_env::{LolBaseEnv, fiora_champion_spec, riven_champion_spec};
use crate::flash_plugin::register_flash_plugin;
...
impl RlEnvironment for FioraV2Env {
    ...
    fn reward_formula_spec() -> Option<RewardFormulaSpec> {
        super::FIORA_V2_SPEC.reward_formula.clone()
    }
}
