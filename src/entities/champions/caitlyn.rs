...
use crate::{BuffCaitlynPassive, BuffOf, DamageType, DebuffSlow, PassiveSkillOf};
...
fn cast_caitlyn_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        CAITLYN_Q_KEY,
        DamageShape::Sector { radius: 1300.0, angle: 15.0 },
        vec![TargetDamage {
...
fn on_caitlyn_damage_hit(
    ...
    commands.entity(target).with_related::<BuffOf>(BuffCaitlynPassive::new());
}
