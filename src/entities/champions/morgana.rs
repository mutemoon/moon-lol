...
use crate::{BuffMorganaE, BuffMorganaQ, DamageType, PassiveSkillOf};
...
fn cast_morgana_e(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffMorganaE::new(150.0, true, 5.0));
}
...
fn on_morgana_damage_hit(
    ...
    // Q roots
    commands.entity(target).with_related::<BuffOf>(BuffMorganaQ::new(2.0, 2.0));
}
