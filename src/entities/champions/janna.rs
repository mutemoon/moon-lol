...
use crate::{BuffJannaPassive, BuffOf, DamageType, DebuffSlow, PassiveSkillOf};
...
fn cast_janna_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        JANNA_Q_KEY,
        DamageShape::Sector { radius: 1760.0, angle: 30.0 },
        vec![TargetDamage {
...
fn on_janna_damage_hit(
    ...
    // Apply passive
    commands.entity(target).with_related::<BuffOf>(BuffJannaPassive::new());
    // W slows
