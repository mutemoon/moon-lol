...
use crate::{BuffJaycePassive, BuffOf, DamageType, PassiveSkillOf};
...
fn cast_jayce_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        JAYCE_Q_KEY,
        DamageShape::Sector { radius: 1050.0, angle: 15.0 },
        vec![TargetDamage {
...
fn cast_jayce_e(commands: &mut Commands, q_transform: &Query<&Transform>, entity: Entity, point: Vec2) {
...
fn on_jayce_damage_hit(
    ...
    // Apply passive
    commands.entity(target).with_related::<BuffOf>(BuffJaycePassive::new());
}
