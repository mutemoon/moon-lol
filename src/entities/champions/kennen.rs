...
use crate::{BuffKennenE, BuffKennenMarkOfStorm, BuffKennenR, DamageType, PassiveSkillOf};
...
fn cast_kennen_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        KENNEN_Q_KEY,
        DamageShape::Sector { radius: 1050.0, angle: 10.0 },
        vec![TargetDamage {
...
fn cast_kennen_e(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffKennenE::new(1.0, 0.6, 2.0));
}
...
fn cast_kennen_r(commands: &mut Commands, entity: Entity) {
    ...
    // R grants armor/mr
    commands.entity(entity).with_related::<BuffOf>(BuffKennenR::new(40.0, 40.0, 3.0));
}
...
fn on_kennen_damage_hit(
    ...
    commands.entity(target).with_related::<BuffOf>(BuffKennenMarkOfStorm::new(1, 8.0));
}
