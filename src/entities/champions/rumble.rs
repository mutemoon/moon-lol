...
use crate::{BuffRumbleW, DamageType, PassiveSkillOf};
...
fn cast_rumble_w(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffRumbleW::new(50.0, 1.5));
}
...
fn cast_rumble_e(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        RUMBLE_E_KEY,
        DamageShape::Sector { radius: 850.0, angle: 15.0 },
        vec![TargetDamage {
            filter: TargetFilter::All,
            amount: hash_bin("TotalDamage"),
            damage_type: DamageType::Magic,
...
fn on_rumble_damage_hit(
    ...
    // E slows
    commands.entity(target).with_related::<BuffOf>(BuffRumbleW::new(50.0, 1.5));
}
