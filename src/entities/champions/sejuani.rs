...
use crate::{BuffSejuaniE, DamageType, PassiveSkillOf};
...
fn on_sejuani_damage_hit(
    ...
    // E stuns
    commands.entity(target).with_related::<BuffOf>(BuffSejuaniE::new(1.0, 1.5));
    // R stuns
    commands.entity(target).with_related::<BuffOf>(BuffSejuaniE::new(1.5, 2.0));
}
