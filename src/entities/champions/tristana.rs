...
use crate::{BuffTristanaW, DamageType, PassiveSkillOf};
...
fn cast_tristana_e(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        TRISTANA_E_KEY,
        DamageShape::Nearest { max_distance: 700.0 },
        vec![TargetDamage {
            filter: TargetFilter::All,
            amount: hash_bin("TotalDamage"),
...
fn on_tristana_damage_hit(
    ...
    commands.entity(target).with_related::<BuffOf>(BuffTristanaW::new(0.5, 2.0));
}
