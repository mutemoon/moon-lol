...
use crate::{BuffQuinnE, BuffQuinnW, DamageType, PassiveSkillOf};
...
fn cast_quinn_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        QUINN_Q_KEY,
        DamageShape::Sector { radius: 1050.0, angle: 20.0 },
        vec![TargetDamage {
...
fn cast_quinn_w(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffQuinnW::new(0.8, 0.4, 2.0));
}
...
fn on_quinn_damage_hit(
    ...
    // E slows
    commands.entity(target).with_related::<BuffOf>(BuffQuinnE::new(0.5, 1.5));
}
