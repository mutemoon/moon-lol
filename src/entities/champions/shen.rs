...
use crate::{BuffShenW, DamageType, PassiveSkillOf};
...
fn cast_shen_w(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffShenW::new(1.0, 1.5));
}
...
fn on_shen_damage_hit(
    ...
    // Q marks with spirit
    commands.entity(target).with_related::<BuffOf>(BuffShenW::new(1.0, 1.5));
}
