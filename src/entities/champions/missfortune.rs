...
use crate::{BuffMissFortuneW, DebuffSlow, DamageType, PassiveSkillOf};
...
fn cast_missfortune_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        MISSFORTUNE_Q_KEY,
        DamageShape::Sector { radius: 550.0, angle: 10.0 },
        vec![TargetDamage {
...
fn cast_missfortune_w(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffMissFortuneW::new(0.6, 1.0, 4.0));
}
...
fn cast_missfortune_r(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        MISSFORTUNE_R_KEY,
        DamageShape::Sector { radius: 1450.0, angle: 45.0 },
        vec![TargetDamage {
            filter: TargetFilter::All,
            amount: hash_bin("TotalDamage"),
            damage_type: DamageType::Physical,
