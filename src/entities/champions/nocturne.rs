...
use crate::{BuffNocturneW, DebuffFear, DamageType, PassiveSkillOf};
...
fn cast_nocturne_w(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffNocturneW::new(0.5, 5.0));
}
...
fn on_nocturne_damage_hit(
    ...
    // E fears
    commands.entity(target).with_related::<BuffOf>(DebuffFear::new(2.0));
}
