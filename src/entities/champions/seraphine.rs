...
use crate::{BuffSeraphineE, BuffSeraphineW, DamageType, PassiveSkillOf};
...
fn cast_seraphine_w(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffSeraphineW::new(50.0, 2.5));
}
...
fn cast_seraphine_e(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        SERAPHINE_E_KEY,
        DamageShape::Sector { radius: 1300.0, angle: 30.0 },
        vec![TargetDamage {
            filter: TargetFilter::All,
            amount: hash_bin("TotalDamage"),
            damage_type: DamageType::Magic,
...
fn cast_seraphine_r(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        SERAPHINE_R_KEY,
        DamageShape::Sector { radius: 1500.0, angle: 50.0 },
        vec![TargetDamage {
            filter: TargetFilter::All,
            amount: hash_bin("TotalDamage"),
            damage_type: DamageType::Magic,
...
fn on_seraphine_damage_hit(
    ...
    // E stuns
    commands.entity(target).with_related::<BuffOf>(BuffSeraphineE::new(0.75, 1.0));
}
