...
use crate::{BuffOrnnQ, DamageType, PassiveSkillOf};
...
fn cast_ornn_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        ORNN_Q_KEY,
        DamageShape::Sector { radius: 750.0, angle: 30.0 },
        vec![TargetDamage {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffOrnnQ::new(0.4, 2.0));
}
...
fn cast_ornn_w(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        ORNN_W_KEY,
        DamageShape::Sector { radius: 500.0, angle: 25.0 },
        vec![TargetDamage {
            filter: TargetFilter::All,
            amount: hash_bin("TotalDamage"),
...
fn on_ornn_damage_hit(
    ...
    // Q slows
    commands.entity(target).with_related::<BuffOf>(BuffOrnnQ::new(0.4, 2.0));
}
