...
use crate::{BuffSennaW, DamageType, PassiveSkillOf};
...
fn cast_senna_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        SENNA_Q_KEY,
        DamageShape::Sector { radius: 600.0, angle: 15.0 },
        vec![TargetDamage {
...
fn cast_senna_r(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        SENNA_R_KEY,
        DamageShape::Sector { radius: 2500.0, angle: 50.0 },
        vec![TargetDamage {
            filter: TargetFilter::All,
            amount: hash_bin("TotalDamage"),
            damage_type: DamageType::Magic,
...
fn on_senna_damage_hit(
    ...
    // W roots
    commands.entity(target).with_related::<BuffOf>(BuffSennaW::new(1.5, 2.0));
}
