...
use crate::{BuffApheliosCalibrum, BuffApheliosGravitum, DamageType, PassiveSkillOf};
...
fn on_aphelios_damage_hit(
    ...
    commands.entity(target).with_related::<BuffOf>(BuffApheliosCalibrum::new(70.0, 2.0));
    commands.entity(target).with_related::<BuffOf>(BuffApheliosGravitum::new(0.5, 2.0));
}
