...
use crate::{BuffAsheQ, BuffOf, DamageType, DebuffSlow, PassiveSkillOf};
...
fn cast_ashe_q(commands: &mut Commands, entity: Entity) {
    ...
    commands.entity(entity).with_related::<BuffOf>(BuffAsheQ::new());
}
...
fn cast_ashe_w(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        ASHE_W_KEY,
        DamageShape::Sector { radius: 1200.0, angle: 40.0 },
        vec![TargetDamage {
...
fn cast_ashe_r(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        ASHE_R_KEY,
        DamageShape::Sector { radius: 20000.0, angle: 10.0 },
        vec![TargetDamage {
