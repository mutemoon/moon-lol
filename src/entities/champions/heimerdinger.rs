...
use crate::{BuffHeimerPassive, BuffOf, DamageType, PassiveSkillOf};
...
fn cast_heimer_w(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        HEIMER_W_KEY,
        DamageShape::Sector { radius: 1150.0, angle: 30.0 },
        vec![TargetDamage {
...
fn on_heimerdinger_damage_hit(
    ...
    // Apply passive
    commands.entity(target).with_related::<BuffOf>(BuffHeimerPassive::new());
}
