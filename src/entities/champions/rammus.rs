...
use crate::{BuffRammusE, BuffRammusQ, BuffRammusR, DamageType, PassiveSkillOf};
...
fn on_rammus_damage_hit(
    ...
    // Q slows
    commands.entity(target).with_related::<BuffOf>(BuffRammusQ::new(0.8, 1.0));
    // E taunts
    commands.entity(target).with_related::<BuffOf>(BuffRammusE::new(2.0, 2.5));
    // R slows
    commands.entity(target).with_related::<BuffOf>(BuffRammusR::new(0.5, 1.5));
}
