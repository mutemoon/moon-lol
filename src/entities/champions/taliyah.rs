...
use crate::{BuffTaliyahW, DamageType, PassiveSkillOf};
...
fn cast_taliyah_q(commands: &mut Commands, entity: Entity) {
    ...
    skill_damage(
        ...
        entity,
        TALIYAH_Q_KEY,
        DamageShape::Sector { radius: 1000.0, angle: 30.0 },
        vec![TargetDamage {
...
fn on_taliyah_damage_hit(
    ...
    commands.entity(target).with_related::<BuffOf>(BuffTaliyahW::new(0.75, 1.0));
}
